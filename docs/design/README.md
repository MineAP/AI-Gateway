...
This directory contains architecture-level design documents.

These documents define internal contracts, responsibilities, and design
principles used by AI Gateway.
